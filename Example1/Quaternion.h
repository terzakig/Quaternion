...
template<typename P = float>
  ...
  private:
	...
	return Quaternion<Pr>(s, v1, v2, v3);
      ...
      /// Convert a rotation to a quaternion in the "north" hemisphere (as close as possible to [1;0;0;0]).
      template<typename Pr>
      //inline static Quaternion<Precision> Rotation2Quaternion(const Precision (&R)[9] ) 
	...
	D3[2][2] = 2 * ( v3 * ( -v3*v3 + v1*v1 + v2*v2 + 1 - s*s ) );
      ...
      */
      ...
      inline void UpdateFromDeltaMRPs( const Pdelta* delta )
      {
	...
	s = s_new; v1 = v1_new; v2 = v2_new; v3 = v3_new;
      ...
      template<typename Pdelta1, 
	       typename Pdelta2, 
	       typename Pdelta3>
      inline void UpdateFromDeltaMRPs( Pdelta1 delta1, Pdelta2 delta2, Pdelta3 delta3 )
      {
